...
public class VeniceQueryRunner
{
    private VeniceQueryRunner() {}
            ...
            throws Exception
    {
        ...
        QueryRunner queryRunner = DistributedQueryRunner.builder(defaultSession)
                ...
                .setNodeCount(1)
                .build();
        queryRunner.installPlugin(new VenicePlugin());
            ...
            throws Exception
    {
        ...
        logger.setLevel("dev.manujose0", Level.DEBUG);
        logger.setLevel("io.trino", Level.INFO);

        QueryRunner queryRunner = createQueryRunner();

        Logger log = Logger.get(VeniceQueryRunner.class);
